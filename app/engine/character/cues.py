...
def big_five_to_behavior_cues(ocean: OceanModel) -> list[str]:
    ...
    if all(0.45 <= v <= 0.55 for v in [
        ocean.openness, ocean.conscientiousness, ocean.extraversion,
        ocean.agreeableness, ocean.emotional_stability,
    ]):
